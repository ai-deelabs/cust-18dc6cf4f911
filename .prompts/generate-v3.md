Build a landing page as a single file `v3.html` — all CSS
and JS inline, no frameworks.

Brand:
Super Spa is a wellness business focusing on relaxation and rejuvenation. The desired look and feel is a Thai-inspired, soothing style that embodies tranquility and comfort, appealing to clients seeking a calming experience. The brand aims to create a serene and inviting atmosphere with natural visuals and soft tones.
